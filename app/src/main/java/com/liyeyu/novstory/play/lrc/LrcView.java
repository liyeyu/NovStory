...
public class LrcView extends View implements ILrcView {
     ...
     * 当前高亮歌词的字体颜色为黄色
     */
    private int mHeightLightRowColor = Color.YELLOW;
    /**
     * 不高亮歌词的字体颜色为白色
     */
...
//        }
    ...
    public void setHeightLightRowColor(int heightLightRowColor) {
        mHeightLightRowColor = heightLightRowColor;
    }

    public void setNormalRowColor(int normalRowColor) {
        mNormalRowColor = normalRowColor;
    }

    public void setLrcFontSize(int lrcFontSize) {
        mLrcFontSize = lrcFontSize;
    }
}
